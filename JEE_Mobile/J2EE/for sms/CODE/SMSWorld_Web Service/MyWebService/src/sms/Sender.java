...
public class Sender implements Runnable {
	...
	private String csca = "+91"; // the message center
	private SerialParameters defaultParameters = new SerialParameters("COM1",
			9600, 0, 0, 8, 1, 0);
	public int step;
	public int status = -1;
			...
			try {
				...
				case 3:
					...
					System.out.println("In Case 3");
					  ...
					  // log ("received ok ="+expectedResult); if
					  (expectedResult>-1){
					  mySerial.send("at+csca=\""+csca+"\""); startTime=(new
					  Date()).getTime(); }else{ step=step-1; }
